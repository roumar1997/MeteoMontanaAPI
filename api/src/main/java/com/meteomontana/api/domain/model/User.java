...
public class User {
    ...
    /**
     * ATENCION: este constructor PONE gearJson A NULL.
     *
     * Ya provoco un fallo real: quien reconstruia el User para cambiar OTRA
     * cosa —el token de notificaciones al arrancar la app, la foto de perfil—
     * borraba sin enterarse el material del usuario. Se guardaba bien y el
     * siguiente arranque lo dejaba vacio, en iOS y en Android por igual.
     *
     * USAR SOLO EN TESTS, donde el material da igual. En codigo de produccion
     * usar SIEMPRE el constructor completo y pasar current.getGearJson().
     */
