 ...
 * El uid viene de Firebase Auth (inmutable).
 * El username lo elige el usuario tras el primer login (puede ser null hasta entonces).
 */
public class User {
    ...
    public User(String uid, String email, String username, String displayName,
                ...
                boolean isAdmin, boolean isPremium,
